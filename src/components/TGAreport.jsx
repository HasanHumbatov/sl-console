...
const TGAreport = () => {
  ...
  //                   </div>
  //                   <div>
  //                     <h4 className='font-semibold mt-2'>Coverage:</h4>
  //                     <h5 className='font-medium'>Overall Coverage:</h5>
  //                     <p>
  ...
  //                     </p>
  //                     <h5 className='font-medium'>Modified Code Coverage:</h5>
  //                     <p>
  //                       <span className='font-medium'>Total Methods:</span>{' '}
  //                       {
  ...
  //                       <h6 className='font-medium'>Overall Coverage:</h6>
  //                       <p>
  //                         <span className='font-medium'>Total Methods:</span>{' '}
  ...
  //                       </p>
  //                       <h6 className='font-medium'>Modified Code Coverage:</h6>
  //                       <p>
  //                         <span className='font-medium'>Total Methods:</span>{' '}
