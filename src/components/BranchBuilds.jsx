...
const BranchBuilds = () => {
  ...
  return (
    <div className='p-4'>
      <h1 className='text-2xl font-bold mb-4'>Service Branch Builds</h1>
      ...
      {builds.length > 0 ? (
          ...
          <tbody>
            {builds.map((build, index) => (
              <tr key={build._id}>
                ...
                <td className='border px-4 py-2'>{build.appName}</td>
                <td className='border px-4 py-2'>{build.branchName}</td>
                <td className='border px-4 py-2'>{build.buildName}</td>
                <td className='border px-4 py-2'>
                  {new Date(build.generated).toLocaleString()}
                </td>
              </tr>
            ))}
          </tbody>
        ...
        <p className='mt-4'>Select service name . . ..</p>
      )}
    </div>
  );
};

export default BranchBuilds;
